...
const (
    ...
    problemTimeEntryUrl   = "problems/%d/time_entries"
    problemTimeEntryIdUrl = "problems/%d/time_entries/%d"
    problemTasksUrl       = "problems/%d/tasks"
    problemTaskIdUrl      = "problems/%d/tasks/%d"
)
